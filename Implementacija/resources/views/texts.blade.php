            ...
            <tr>
                <form method="GET" action="{{route('search_texts')}}">
                    <td class="col-sm-1 align-middle text-center">
                        <a type="button" href="{{route('recommend_texts')}}" id="starButton" class="btn btn-warning w-100" title="Preporuči mi tekstove">⭐</a>
                    </td>
                    ...
                    <td class="col-sm-2">
                        <select class="form-select" name="duzina">
                            <option selected value="0">Bilo koja dužina</option>
                            <option value="1" @if ($duzina == 1) selected @endif>Kratki: < 20 reči</option>
                            <option value="2" @if ($duzina == 2) selected @endif>Srednji: 20-50 reči</option>
                            <option value="3" @if ($duzina == 3) selected @endif>Dugi: > 50 reči</option>
                        </select>
                    </td>

                    <!-- Submit dugme -->
                    <td class="col-sm align-middle text-center">
                        <button class="btn btn-secondary w-100" type="submit">Pretraži &nbsp🔎</button>
                    </td>
                </form>
